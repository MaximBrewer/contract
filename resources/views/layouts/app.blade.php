...
<head>
    ...
    <!-- Styles -->
    <link href="{{ asset('css/app.css') }}?ver=3.58" rel="stylesheet">
    <script>
...
<body class="d-flex flex-column">
                                ...
                                @foreach ($kinds as $kind)
                                    ...
                                    @else
                                        <a class="dropdown-item"
                                            href="/personal?kind={{ $kind->id }}">{{ $kind->title }}</a>
                                    @endguest
                                @endforeach
                            </div>
                        </li>
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <router-link :to="{name: 'contracts'}" class="dropdown-item">
                                        {{ __('Предложенные мной') }}
                                    </router-link>
                                    <router-link :to="{name: 'contractsReciever'}" class="dropdown-item">
                                        {{ __('Предложенные мне') }}
                                    </router-link>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <router-link :to="{name: 'auctionIndex'}" class="dropdown-item">
                                        {{ __('All auctions') }}
                                    </router-link>
                                    ...
                                    <router-link :to="{name: 'joints'}" class="dropdown-item">
                                        {{ __('Совместные закупки') }}
                                    </router-link>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <router-link :to="{name: 'dialoguesIndex'}" class="dropdown-item">
                                        {{ __('Messages') }}
                                    </router-link>
                                    ...
                                    <router-link :to="{name: 'jointPurchases'}" class="dropdown-item">
                                        {{ __('Совместные закупки') }}
                                    </router-link>

                                    <router-link :to="{name: 'historyPurchases'}" class="dropdown-item">
                                        {{ __('История закупок') }}
                                    </router-link>



                                    <router-link :to="{name: 'settlementsIndex'}" class="dropdown-item">
                                        {{ __('Mutual Settlements') }}
                                    </router-link>
    ...
    @include ('footer')
    <!-- Scripts -->
    <script src="{{ asset('js/app.js') }}?ver=3.58" defer></script>
