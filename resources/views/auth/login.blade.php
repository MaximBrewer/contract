...
<form method="POST" action="{{ route('login') }}" class="px-4 py-3">
    ...
    <div class="dropdown-divider"></div>
    <p>{{ __('Each time you visit the project you agree to') }} <a href="https://www.cross-contract.ru/oferta">{{ __('terms of use Cross-Contract.ru') }}</a></p>
    {{-- <div class="col-md-4">
                    <p>{{ __('if this is your first time in the project, click') }} <a class="btn btn-primary"
