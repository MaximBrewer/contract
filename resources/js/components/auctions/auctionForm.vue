        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div role="alert" class="invalid-feedback" v-if="errors.can_bet">
              <span v-for="(error, index) in errors.can_bet" :key="index">{{
                error
              }}</span>
            </div>
          </div>
          <div class="form-group">
            ...
            <div role="alert" class="invalid-feedback" v-if="errors.autosale">
              <span v-for="(error, index) in errors.autosale" :key="index">{{
                error
              }}</span>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <span
              role="alert"
              class="invalid-feedback"
              v-if="errors['multiplicity_id']"
            >
              <strong
                v-for="(error, index) in errors['multiplicity_id']"
                :key="index"
                >{{ error }}</strong
              >
            </span>
          ...
          <div class="form-group" v-if="auction.mode == 'future'">
            ...
            <span
              role="alert"
              class="invalid-feedback"
              v-if="errors.delay_sell"
            >
              <strong
                v-for="(error, index) in errors.delay_sell"
                :key="index"
                >{{ error }}</strong
              >
            </span>
          ...
          <div class="form-group" v-if="auction.mode == 'future'">
            ...
            <span role="alert" class="invalid-feedback" v-if="errors.delay_buy">
              <strong v-for="(error, index) in errors.delay_buy" :key="index">{{
                error
              }}</strong>
            </span>
          </div>
          <div class="form-group">
            ...
            >
              <strong
                v-for="(error, index) in errors['store_id']"
                :key="index"
                >{{ error }}</strong
              >
            </span>
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <span role="alert" class="invalid-feedback" v-if="errors.step">
              <strong v-for="(error, index) in errors.step" :key="index">{{
                error
              }}</strong>
            </span>
          </div>
          <div class="form-group">
            ...
            <span role="alert" class="invalid-feedback" v-if="errors.start_at">
              <strong v-for="(error, index) in errors.start_at" :key="index">{{
                error
              }}</strong>
            </span>
          </div>
          <div class="form-group">
            ...
            <span role="alert" class="invalid-feedback" v-if="errors.finish_at">
              <strong v-for="(error, index) in errors.finish_at" :key="index">{{
                error
              }}</strong>
            </span>
          </div>
          <div class="form-group">
            ...
            <span role="alert" class="invalid-feedback" v-if="errors.prepay">
              <strong v-for="(error, index) in errors.prepay" :key="index">{{
                error
              }}</strong>
            </span>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="intervals">
              <ul>
                <li
                  class="interval"
                  v-for="(model, index) in auction.intervals"
                  :key="index"
                >
                  <input
                    type="hidden"
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <input
                          ...
                          v-bind:class="{
                            'is-invalid':
                              errors['intervals.' + index + '.start_price'],
                          }"
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <datetime
                          ...
                          v-model="model.to"
                          v-bind:class="{
                            'is-invalid': errors['intervals.' + index + '.to'],
                          }"
                        ></datetime>
                        <div
                          role="alert"
...
export default {
  ...
  methods: {
    changeModel(e) {
      ...
      switch (e) {
        case "price2day":
          this.auction.can_bet = "yes";
          this.auction.autosale = "yes";
          break;
        case "future":
          this.auction.can_bet = "yes";
          this.auction.autosale = "no";
          break;
        case "callApp":
          this.auction.can_bet = "yes";
          this.auction.autosale = "no";
    ...
    saveForm() {
      ...
      this.formData.set(
        "delay_sell",
        !!app.auction.delay_sell ? app.auction.delay_sell : 0
      );
      this.formData.set(
        "delay_buy",
        !!app.auction.delay_buy ? app.auction.delay_buy : 0
      );
